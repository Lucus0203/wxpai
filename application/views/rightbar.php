<div class="rightBarBox" style="display: none;">
        ...
        <div class="rightBar">
                <ul class="rightBarList">
                    ...
                    <?php if($annualSurveyStatus>0){?>
                        <li><a href="<?php echo site_url('annual/answer') ?>">年度调研<span class="orange f12 ml10"><?php if($annualSurveyStatus==2){echo '已完成';}else{echo '待完成';} ?></span></a></li>
                    <?php } ?>
