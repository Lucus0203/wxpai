...
$(document).ready(function(){
    $('#more').click(function(){
        ...
        $.ajax({
                type:"post",
                url:'<?php echo site_url('course/moremycourse') ?>',
                data:{'num':num},
                datatype:'jsonp',
...
<header class="clearfix" id="gHeader">
        <div class="header">我报名的课程<a href="javascript:void(0);"><i class="ilevel">=</i></a></div>
            ...
            <div class="listBox">
                ...
                <?php foreach ($courses as $c){?>
                    <div class="listCont">
                        ...
                        <div class="imgBox"><a href="<?php echo site_url('course/info/'.$c['id']) ?>"><img src="<?php echo $this->config->item('pc_url').'uploads/course_img/'.$c['page_img'] ?>" alt="" width="160"></a></div>
                            <div class="listText">
                <p class="titp"><a href="<?php echo site_url('course/info/'.$c['id']) ?>"><?php echo $c['title'] ?></a>
                    <?php if($c['status']==1){//1报名中2进行中3结束5待开启报名9其他 ?>
